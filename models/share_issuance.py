...
class ShareIssuance(Base):
    ...
    shareholder_id = Column(String(36), ForeignKey("shareholderprofile.id"), nullable=False)
    ...
    shareholder = relationship("models.shareholder.ShareholderProfile", back_populates="issuances")
